...
<div class="card p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('bahan.create') }}" class="btn btn-primary"><i
    class="ti ti-plus"></i> Tambah Bahan Baku</a>
    </div>
    @if (session('success'))
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('bahan.destroy', $bahan->id) }}" method="POST"
                                class="d-inline" onsubmit="return confirm('Yakin hapus bahan baku ini?')">
                                @csrf
                                @method('DELETE')
